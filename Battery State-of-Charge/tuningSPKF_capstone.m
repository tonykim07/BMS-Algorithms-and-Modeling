...
% Helper function to update the SPKF data structures every measuremetn
% interval
...
% Function for tuning values for the process-noise, sensor-noise, and
% initial SOC-estimation error covariance matrices

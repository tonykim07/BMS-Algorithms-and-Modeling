% Tuning an EKF (extended kalman filter) for SOC estimation

addpath readonly
load readonly/PAN_CAPSTONE_DATA.mat;
...
% Call function that gets tuned values
...
% Helper function to initialize the EKF data structures
...
% Helper function to update EKF data structures every measurement interval
...
% Function to tune values for the process-noise, sensor-noise, and initial
% values were tuned and selected as shown below
% SOC-estimation error covariance matrices
